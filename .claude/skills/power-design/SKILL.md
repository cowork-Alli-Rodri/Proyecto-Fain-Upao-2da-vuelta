...
1. `.claude/skills/power-design/principles/design-principles.md` — the 20 rules with numeric thresholds. **All 20 are non-negotiable.**
2. The chosen `.claude/skills/power-design/brands/<name>/brand-style.md` — the brand DNA tokens
3. `.claude/skills/power-design/brands/_template.md` (if present) — structural reference for the output
...
- `.claude/skills/power-design/principles/design-principles.md` — the 20 rules + research, with numeric thresholds
- `.claude/skills/power-design/lib/extract-brand.md` — Firecrawl recipe to extract brand DNA from any URL
- `.claude/skills/power-design/brands/<name>/brand-style.md` — pre-built brand systems (add as needed)
- `.claude/skills/power-design/brands/_template.md` — blank template for new brands
