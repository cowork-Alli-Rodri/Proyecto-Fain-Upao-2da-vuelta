...
Use `.claude/skills/power-design/brands/_template.md` as the schema. Fill in:
...
```bash
sed -i '' 's/fill="#FFFFFF"/fill="#YOUR_BRAND_COLOR"/g' brands/<slug>/logo.svg
```

---

## Fast scan — minimum viable extract
